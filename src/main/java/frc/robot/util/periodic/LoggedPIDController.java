...
// Modified to log values to AdvantageKit
...
import frc.robot.util.periodic.PeriodicUtil.Periodic;

public class LoggedPIDController extends Periodic implements Sendable, AutoCloseable {
    ...
    public static LoggedPIDController fromPIDController(PIDController pidController, String name) {
        ...
        loggedPIDController.setIZone(pidController.getIZone());
        loggedPIDController.setTolerance(pidController.getPositionTolerance(), pidController.getVelocityTolerance());

        return loggedPIDController;
    }
    ...
    public double calculate(double measurement) {
        ...
        double p = m_kp * m_positionError;
        double i = m_ki * m_totalError;
