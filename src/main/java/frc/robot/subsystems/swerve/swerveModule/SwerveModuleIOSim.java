...
public class SwerveModuleIOSim implements SwerveModuleIO {
    ...
    private DCMotorSim driveSim = new DCMotorSim(DCMotor.getNEO(1), SwerveModuleConstants.kDriveGearRatio, 0.025);
    private DCMotorSim turnSim = new DCMotorSim(DCMotor.getNEO(1), SwerveModuleConstants.kTurnGearRatio, 0.004);
